#!/usr/bin/env python3
"""Cocotb simulation runner for the multi-level wb_cache hierarchy stress
tests (invoked by CMake)."""
...
SCRIPT_DIR         = Path(__file__).parent.resolve()          # wb_cache_hierarchy/ -> testing/ -> wishbone/ -> VHDL/
VHDL_ROOT          = SCRIPT_DIR.parent.parent.parent
REPO_ROOT          = VHDL_ROOT.parent
COCOTB_LIB         = VHDL_ROOT / "cocotb"
_DEFAULT_BUILD_DIR = REPO_ROOT / "build" / "sim" / "sim_wb_cache_hierarchy"
