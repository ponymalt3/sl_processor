...
# ACDS 17.1 590 linux 2019.01.01.15:47:42
...
# ----------------------------------------
# If memclk is one of several IP cores in your
...
TOP_LEVEL_NAME="memclk"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/malte/intelFPGA_lite/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/memclk_altclkctrl_0.v" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/memclk.vhd"                                                                                 
fi
