...
set_multicycle_path -setup -end -through [get_pins -hierarchical {*|*ena*}]  -to [get_fanouts [get_pins -hierarchical {*core_clk_gate|q*}]] 2
set_multicycle_path -hold -end -through [get_pins -hierarchical {*|*ena*}]  -to [get_fanouts [get_pins -hierarchical {*core_clk_gate|q*}]] 1
