...
MTEST(testReadQfp32,test_that_positive_minimum_value_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(0.00000006).asUint);  
}
...
MTEST(testReadQfp32,test_that_positive_value_for_exp_0_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(30.99999994).asUint);  
}
...
MTEST(testReadQfp32,test_that_positive_value_for_exp_1_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(6034.33452).asUint);  
}
...
MTEST(testReadQfp32,test_that_positive_value_for_exp_2_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(113530.23438).asUint);  
}
...
MTEST(testReadQfp32,test_that_positive_value_for_exp_3_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(67823842).asUint);  
}
...
MTEST(testReadQfp32,test_that_positive_max_value_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(536870911).asUint);  
}
...
MTEST(testReadQfp32,test_that_negative_value_for_exp_0_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(-0.674395978).asUint);  
}
...
MTEST(testReadQfp32,test_that_negative_value_for_exp_1_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(-439.874389648).asUint);  
}
...
MTEST(testReadQfp32,test_that_negative_value_for_exp_2_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(-656875.875).asUint);  
}
...
MTEST(testReadQfp32,test_that_negative_value_for_exp_3_is_ok)
{
  ...
  EXPECT(tester.getProcessor().readMemory(0) == qfp32_t(-83465848).asUint);  
}
